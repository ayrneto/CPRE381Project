...
architecture structure of RISCV_Processor is
  ...
  signal s_ID_ShiftedImm: std_logic_vector(N-1 downto 0);
...
begin
  ...
  s_ID_ShiftedImm <= s_ID_Imm(30 downto 0) & '0';
  ...
  s_ALUInputA <= s_EX_PC when s_EX_AUIPC = '1' else s_EX_ReadData1;
  s_ALUInputB <= s_EX_Imm when s_EX_ALUSrc = '1' else s_EX_ReadData2;
